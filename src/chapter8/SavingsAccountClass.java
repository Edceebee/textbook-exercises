...
public class SavingsAccountClass {
        ...
        public double calculateMonthlyInterest (){
            ...
            double newSavingsBalance = monthlyInterest + savingsBalance;
            System.out.println("New savings is " + newSavingsBalance);
            return savingsBalance;
        }

        public static void modifyInterestRate(){
            annualInterest = 0.50;
            System.out.println("modified annual rate is " + annualInterest);
        }
